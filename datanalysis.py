...
def scelta1file(nome,titolo,colore):
      ...
      if colore not in ["red","marron","green","olive","limegreen","blue","navy","darkcyan","lightsteelblue","pink","magenta","darkviolet"]:
        colori=False
      ...
      if colori==True and check==True:
        ...
        print("Poiché non sono stati inseriti tutti i valori giusti, provvederemo a fornire un dataframe di default per permettere il normale funzionamento del programma.")
        print("Useremo i dati dell'anno 2022 mensili del titolo 'FERRARI")
...
def scelta2file(nome1,titolo1,colore1,nome2,titolo2,colore):
  ...
  if colore1 not in ["red","marron","green","olive","limegreen","blue","navy","darkcyan","lightsteelblue","pink","magenta","darkviolet"]:
    colori1=False
    print("Il primo colore è tra quelli selezionati." )
  if colore2 not in  ["red","marron","green","olive","limegreen","blue","navy","darkcyan","lightsteelblue","pink","magenta","darkviolet"]:
    colori2=False
    print("Il secondo colore è tra quelli selezionati." )
  
  if check1==True and check2==True and equal==True and colori1==True and colori2==True:
    return dataFR1,colore1,titolo1,dataFR2,colore2,titolo2 
  else:
    print("Poiché non sono stati inseriti tutti i valori giusti, provvederemo a fornire due dataframe di default per permettere il normale funzionamento del programma.")
    print("Useremo i dati dell'anno 2022 mensili dei titoli 'FERRARI' e 'FORD'")
...
def scelta3file(nome1,titolo1,colore1,nome2,titolo2,colore2,nome3,titolo3,colore3):
  ...
  if dataFR1["Date"].equals(dataFR3["Date"])=="False":
    equal3=False
    print("Non sono presenti lo stesso numero di valori nel primo e terzo file")
  ...
  if colore2 not in ["red","marron","green","olive","limegreen","blue","navy","darkcyan","lightsteelblue","pink","magenta","darkviolet"]:
    colori2=False
    print("Il secondo colore è tra quelli selezionati." )
  if colore3 not in ["red","marron","green","olive","limegreen","blue","navy","darkcyan","lightsteelblue","pink","magenta","darkviolet"]:
    colori3=False
    print("Il terzo colore è tra quelli selezionati." )
  ...
  if check1==True and check2==True and check3==True and equal1==True and equal2==True and equal3==True and colori1==True and colori2==True and colori3==True:
    ...
    print("Poiché non sono stati inseriti tutti i valori giusti, provvederemo a fornire tre dataframe di default per permettere il normale funzionamento del programma.")
    print("Useremo i dati dell'anno 2022 mensili dei titoli 'FERRARI', e 'FORD'")
...
#input
def scelta1():
  nome1=input("Inserire il nome del file csv su cui hai salvato i dati del titolo: ")
  nome_tot1=nome1+".csv"
  data1=pd.read_csv(nome_tot1,header=0,parse_dates=["Date"])
  dataFR1=pd.DataFrame(data1)
  ...
  print("SCELTA COLORE: red, marron, green, olive, limegreen, blue, navy, darkcyan, lightsteelblue, pink, magenta, darkviolet")
  colore1=input("Scegli un colore (tra quelli indicati) per i grafici riguardanti il titolo:")
  while colore1 not in ["red","marron","green","olive","limegreen","blue","navy","darkcyan","lightsteelblue","pink","magenta","darkviolet"]:
...
def scelta2():
  ...
  condizione=True
  while condizione:
    if colore1 in ["red","marron","green","olive","limegreen","blue","navy","darkcyan","lightsteelblue","pink","magenta","darkviolet"] and colore2 in  ["red","marron","green","olive","limegreen","blue","navy","darkcyan","lightsteelblue","pink","magenta","darkviolet"]:
...
def scelta3():
  ...
  nome3=input("Inserire il nome del file csv su cui hai salvato i dati del terzo titolo: ")
  nome_tot3=nome3+".csv"
  data3=pd.read_csv(nome_tot3,header=0,parse_dates=["Date"])
  dataFR3=pd.DataFrame(data3)
  ...
  condizione=True
  while condizione:
    if colore1 in ["red","marron","green","olive","limegreen","blue","navy","darkcyan","lightsteelblue","pink","magenta","darkviolet"] and colore2 in ["red","marron","green","olive","limegreen","blue","navy","darkcyan","lightsteelblue","pink","magenta","darkviolet"] and colore3 in ["red","marron","green","olive","limegreen","blue","navy","darkcyan","lightsteelblue","pink","magenta","darkviolet"]:
...
if scelta=="FILE":
  ...
  print("numero titoli da confrontare (minimo 1, massimo 3), nome del file csv su cui sono riportati i dati, nome del titolo, colore scelto per quel titolo tra le seguenti opzioni red, marron, green, olive, limegreen, blue, navy, darkcyan, lightsteelblue, pink, magenta, darkviolet.") 
  ...
  if l[0].strip()=="1" and len(l)==4:
    if len(l)==4:
      ...
      grafico_candele(dataFR1,titolo1,colore1)
      media_mobile1(dataFR1,colore1)
      dispersione1(dataFR1,titolo1,colore1)
      pie(dataFR1,colore1,titolo1)
      OBV(dataFR1,colore1)
      rendimenti_percentuali1(dataFR1,colore1,titolo1)
      qr=qr_code()
      print(qr)
    
    else:
      print("Non hai inserito tutti i dati richiesti")
      print("Per garantire il funzionamento del programma abbiamo dato di default i dati storici dell'anno 2022 mensili del titolo 'FERRARI'.")
    ...
    if len(l)==7:
      ...
      grafico_candele(dataFR1,titolo1,colore1)
      grafico_candele(dataFR2,titolo2,colore2)
      media_mobile2(dataFR1,dataFR2,colore1,colore2,titolo1,titolo2)
      dispersione2(dataFR1,titolo1,colore1,dataFR2,titolo2,colore2)
      pie(dataFR1,colore1,titolo1)
      pie(dataFR2,colore2,titolo2)
      OBV2(dataFR1,dataFR2,colore1,colore2,titolo1,titolo2)
      rendimenti_percentuali2(dataFR1,dataFR2,colore1,colore2,titolo1,titolo2)
      qr=qr_code()
      print(qr)
    
    else:
      print("Non hai inserito tutti i dati richiesti")
      print("Per garantire il funzionamento del programma abbiamo dato di default i dati mensili dell'anno 2022 dei titoli 'FERRARI' e 'FORD'.")
      dataFR1,colore1,titolo1,dataFR2,colore2,titolo2=errore2()
    ...
    if len(l)==10:
      ...
      grafico_candele(dataFR1,titolo1,colore1)
      grafico_candele(dataFR2,titolo2,colore2)
      grafico_candele(dataFR3,titolo3,colore3)
      media_mobile3(dataFR1,dataFR2,dataFR3,colore1,colore2,colore3,titolo1,titolo2,titolo3)
      dispersione3(dataFR1,titolo1,colore1,dataFR2,titolo2,colore2,dataFR3,titolo3,colore3)
      pie(dataFR1,colore1,titolo1)
      pie(dataFR2,colore2,titolo2)
      pie(dataFR3,colore3,titolo3)
      OBV3(dataFR1,dataFR2,dataFR3,colore1,colore2,colore3,titolo1,titolo2,titolo3)
      rendimenti_percentuali3(dataFR1,dataFR2,dataFR3,colore1,colore2,colore3,titolo1,titolo2,titolo3)
      qr=qr_code()
      print(qr)
...
"""Con il break interrompo il ciclo while e for.L'istruzione continue invece è simile a break, ma invece di interrompere il ciclo fa saltare tutto il codice dopo l'istruzione e fa ripartire Python dalla prima riga del ciclo.
...
fig.write_image("DATANALYSIS.pdf")
