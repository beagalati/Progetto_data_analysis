...
print("WELCOME TO DATA ANALYSIS, il programma il cui obiettivo è quello di fornire un'analisi dei dati forniti dall'utente.")
print("ATTENZIONE: ricorda devi inserire i dati riguardanti OPEN, CLOSE, ADJ CLOSE, HIGH, LOW, VOLUME, solo così l'analisi sarà il quanto più esaustiva possibile.")
print("SUGGERIMENTO: il consiglio è di prendere i dati storici da Yahoo Finance.")
